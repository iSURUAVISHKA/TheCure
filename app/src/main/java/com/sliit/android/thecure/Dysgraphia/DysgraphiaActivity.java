package com.sliit.android.thecure.Dysgraphia;
...
import com.sliit.android.thecure.Dysgraphia.views.DrawModel;
import com.sliit.android.thecure.Dysgraphia.views.DrawView;
...
public class DysgraphiaActivity extends Activity implements View.OnClickListener, View.OnTouchListener {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mClassifiers.add(
                            TensorFlowClassifier.create(getAssets(), "NUMBERS",
    ...
    private Bitmap getDrawing(View view){
