package com.sliit.android.thecure.Dysgraphia.models;
...
public class TensorFlowClassifier implements Classifier {
   ...
   //given a model, its label file, and its metadata
    ...
    public static TensorFlowClassifier create(AssetManager assetManager, String name,
                                              ...
                                              int numClasses,boolean feedKeepProb) throws IOException {
...
//        int numClasses = 10;
    ...
    public Classification recognize(final float[] pixels) {
        ...
        Log.d("TLOG","STAGE 1 : feed completed");
        ...
        Log.d("TLOG","STAGE 2 : run");
        //get the output
        tfHelper.fetch(outputName, output);
        Log.d("TLOG","STAGE 3 : fetch");
